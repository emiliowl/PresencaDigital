...
/*
 * JPanelCadastraAluno.java
 *
 * Created on 10/10/2009, 16:22:41
 */
 ...
 * @author Emilio
 */
public class JPanelCadastraAluno extends javax.swing.JPanel {

    ControladorJanelas controladorJanelas;
    AlunoDAO alunoDAO = new AlunoDAO();
    ArrayList<Aluno> alunos;

    /** Creates new form JPanelCadastraAluno */
    public JPanelCadastraAluno() {
        initComponents();
    }

    public JPanelCadastraAluno(ControladorJanelas controladorJanelas) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Nome", "CPF", "RA" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cabecalhoTabela[] = new String [] {"NOME", "CPF", "RA"};
        alunos = alunoDAO.buscaPorColuna(jComboBox1.getSelectedItem().toString(), jTextField1.getText() != null ? jTextField1.getText() : "");
        System.out.println(alunos.size());
        Object[][] dados = new Object[alunos.size()][3];
        for(int i = 0; i < dados.length; i++) {
            dados[i][0] = alunos.get(i).getNome();
            dados[i][1] = alunos.get(i).getCpf();
            dados[i][2] = alunos.get(i).getRa();
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Aluno alunoEscolhido = (Aluno)alunoDAO.buscaPorColuna("CPF", cpf).get(0);
        this.controladorJanelas.navegar(TelaEscolhida.CADASTRA_IMPRESSAO_ALUNO, alunoEscolhido);
